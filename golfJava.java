 ...
 * @version: 1.0 14 de septiembre del 2020
 */
...
public class golfJava {
    ...
    public static void main(String[] args) {
         ...
         * usara una matriz de strings para poder llenar cada valor según corresponda
         */

        // [Cielo][Temperatura][Humedad][Viento][Se jugó]
        String[][] matrizValores = { { "Lluvia", "Calor", "Alta", "No", "No" },
                { "Lluvia", "Calor", "Alta", "Si", "No" }, { "Nublado", "Calor", "Alta", "No", "Si" },
                { "Soleado", "Templado", "Alta", "No", "Si" }, { "Soleado", "Frío", "Normal", "No", "Si" },
                { "Soleado", "Frío", "Normal", "Si", "No" }, { "Nublado", "Frío", "Normal", "Si", "Si" },
                { "Lluvia", "Templado", "Alta", "No", "No" }, { "Lluvia", "Frío", "Normal", "No", "Si" },
                { "Soleado", "Templado", "Normal", "No", "Si" }, { "Lluvia", "Templado", "Normal", "Si", "Si" },
                { "Nublado", "Templado", "Alta", "Si", "Si" }, { "Nublado", "Calor", "Normal", "No", "Si" },
                { "Soleado", "Templado", "Alta", "Si", "No" }, };

        // Parámetros que debe indicar el usuario que serán los que quiere averiguar
        String paramCielo = "Lluvia";
        String paramTemp = "Frio";
        String paramHumedad = "Alta";
        String paramViento = "Si";
        ...
        // Calculo de matrices de frecuencia para cada dato
    ...
    public static int calcularJugados(String[][] matrizDatos) {
        int cantidadSi = 0;
        for (int i = 0; i < matrizDatos.length; i++) {
            if (matrizDatos[i][4].equals("Si")) {
                cantidadSi++;
            }
        }
        return cantidadSi;
